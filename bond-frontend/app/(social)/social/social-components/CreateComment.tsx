        ...
        <div className='w-[70vw] h-[80vh] bg-[#E8E8E6] rounded-xl '>
          ...
          <div className='flex w-full overflow-hidden '>
            ...
            <div className='w-[50%] h-[60vh] relative'>
              <div className='h-full overflow-auto w-full pl-5'>
                {postComments?.map((current_comment, index) => (
                  <>
                    {current_comment.parentpost._id === post_id && (
                      <>
                        <div className='mb-5 flex pr-5' key={index}>
                          ...
                          <div className='ml-3 text-sm'>
                            ...
                            <div className='flex items-center'>
                              ...
                              <div
                                ...
                                onClick={(e) =>
                                  handle_delete_comment(e, current_comment._id)
                                }
                              >
                                <RiDeleteBin7Line />
                              </div>
                              ...
                              >
                                <div className='w-[50vw] h-[50vh] bg-[#E8E8E6] rounded-xl '>
                                  <textarea
                                    name=''
                                    id=''
                                    className='w-full h-fu resize-none'
                                    value={current_comment._id}
                                  ></textarea>
                                  <p>{index}</p>
                                </div>
                              </div>
